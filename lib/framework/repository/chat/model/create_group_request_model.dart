...
//
//     final createGroupRequestModel = createGroupRequestModelFromJson(jsonString);

import 'dart:convert';

CreateGroupRequestModel createGroupRequestModelFromJson(String str) =>
    CreateGroupRequestModel.fromJson(json.decode(str));

String createGroupRequestModelToJson(CreateGroupRequestModel data) =>
...
class CreateGroupRequestModel {
  ...
  factory CreateGroupRequestModel.fromJson(Map<String, dynamic> json) =>
      CreateGroupRequestModel(
        ...
        participants: json["participants"] == null
            ? []
            : List<Admin>.from(
                json["participants"]!.map((x) => Admin.fromJson(x))),
        unreadCount: json["unread_count"] == null
            ? []
            : List<LastMessage>.from(
                json["unread_count"]!.map((x) => LastMessage.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "unread_count": unreadCount == null
            ? []
            : List<dynamic>.from(unreadCount!.map((x) => x.toJson())),
