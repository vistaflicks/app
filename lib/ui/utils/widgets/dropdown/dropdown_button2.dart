...
class _DropdownRoutePage<T> extends StatelessWidget with BaseStatelessWidget {
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  /// its own decorations, like [CustomInputDecorator].
  final bool isDense;
...
class DropdownButtonFormField2<T> extends FormField<T> {
    ...
    String? barrierLabel,
        ...
        super(
          ...
          builder: (FormFieldState<T> field) {
            ...
            final CustomInputDecoration decorationArg =
                getInputDecoration(decoration, buttonStyleData);
            final CustomInputDecoration effectiveDecoration =
  ...
  ///
  /// If not specified, an [CustomInputDecorator] with the `focusColor` set to the
  /// supplied `focusColor` (if any) will be used.
  final CustomInputDecoration decoration;

  static CustomInputDecoration getInputDecoration(
      CustomInputDecoration? decoration, ButtonStyleData? buttonStyleData) {
    return decoration ??
