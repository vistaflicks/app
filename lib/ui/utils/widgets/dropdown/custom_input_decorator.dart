    ...
    return Semantics(
      ...
      child: FadeTransition(
        ...
        child: FractionalTranslation(
            ...
            child: Padding(
              padding: widget.errorPadding ?? const EdgeInsets.only(left: 0),
              child: Text(
                widget.errorText!,
...
/// See also:
///
///  * [CustomInputDecoration.floatingLabelBehavior] which defines the behavior for
///    [CustomInputDecoration.label] or [CustomInputDecoration.labelText].
...
/// See also:
///
///  * [CustomInputDecoration.floatingLabelAlignment] which defines the alignment for
///    [CustomInputDecoration.label] or [CustomInputDecoration.labelText].
...
class FloatingLabelAlignment {
  ...
  /// Align the floating label on the leading edge of the [CustomInputDecorator].
  ///
  ...
  /// Aligns the floating label to the center of an [CustomInputDecorator].
...
class _RenderDecoration extends RenderBox with SlottedContainerRenderObjectMixin<_DecorationSlot, RenderBox> {
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    ...
    final double inputWidth = math.max(
      0.0,
      constraints.maxWidth - (_boxSize(icon).width + contentPadding.left + _boxSize(prefixIcon).width + _boxSize(prefix).width + _boxSize(suffix).width + _boxSize(suffixIcon).width + contentPadding.right),
    );
...
///
/// [CustomInputDecorator] displays the visual elements of a Material Design text
/// field around its input [child]. The visual elements themselves are defined
/// by an [CustomInputDecoration] object and their layout and appearance depend
/// on the `baseStyle`, `textAlign`, `isFocused`, and `isEmpty` parameters.
///
/// [TextField] uses this widget to decorate its [EditableText] child.
///
/// [CustomInputDecorator] can be used to create widgets that look and behave like a
...
/// See also:
///
///  * [TextField], which uses an [CustomInputDecorator] to display a border,
...
class CustomInputDecorator extends StatefulWidget {
  ...
  ///
  /// Null [CustomInputDecoration] properties are initialized with the corresponding
  ...
  /// See also:
  ///
  ///  * [CustomInputDecoration.hoverColor], which is also blended into the focus
  ...
  /// [CustomInputDecoration.hoverColor] with [CustomInputDecoration.fillColor] when
  /// true, and [CustomInputDecoration.fillColor] when not.
  ///
  /// Defaults to false.
  final bool isHovering;
  ...
  @override
  State<CustomInputDecorator> createState() => _CustomInputDecoratorState();

  /// The RenderBox that defines this decorator's "container". That's the
  /// area which is filled if [CustomInputDecoration.filled] is true. It's the area
  /// adjacent to [CustomInputDecoration.icon] and above the widgets that contain
  /// [CustomInputDecoration.helperText], [CustomInputDecoration.errorText], and
  /// [CustomInputDecoration.counterText].
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<CustomInputDecoration>('decoration', decoration));
...
class _CustomInputDecoratorState extends State<CustomInputDecorator> with TickerProviderStateMixin {
  ...
  CustomInputDecoration? _effectiveDecoration;

  CustomInputDecoration get decoration => _effectiveDecoration ??= widget.decoration.applyDefaults(const CustomInputDecorationTheme());
  ...
  Color _getFillColor(ThemeData themeData, CustomInputDecorationTheme defaults) {
  ...
  Color _getIconColor(ThemeData themeData, CustomInputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(decoration.iconColor, materialState) ?? WidgetStateProperty.resolveAs(themeData.inputDecorationTheme.iconColor, materialState) ?? WidgetStateProperty.resolveAs(defaults.iconColor!, materialState);
  }

  Color _getPrefixIconColor(ThemeData themeData, CustomInputDecorationTheme defaults) {
  ...
  Color _getSuffixIconColor(ThemeData themeData, CustomInputDecorationTheme defaults) {
  ...
  TextStyle _getInlineLabelStyle(ThemeData themeData, CustomInputDecorationTheme defaults) {
    final TextStyle defaultStyle = WidgetStateProperty.resolveAs(defaults.labelStyle!, materialState);

    final TextStyle? style = WidgetStateProperty.resolveAs(decoration.labelStyle, materialState) ?? WidgetStateProperty.resolveAs(themeData.inputDecorationTheme.labelStyle, materialState);
  ...
  // i.e. when they appear in place of the empty text field.
  TextStyle _getInlineHintStyle(ThemeData themeData, CustomInputDecorationTheme defaults) {
    final TextStyle defaultStyle = WidgetStateProperty.resolveAs(defaults.hintStyle!, materialState);

    final TextStyle? style = WidgetStateProperty.resolveAs(decoration.hintStyle, materialState) ?? WidgetStateProperty.resolveAs(themeData.inputDecorationTheme.hintStyle, materialState);

    return themeData.textTheme.titleMedium!.merge(widget.baseStyle).merge(defaultStyle).merge(style);
  }

  TextStyle _getFloatingLabelStyle(ThemeData themeData, CustomInputDecorationTheme defaults) {
    ...
    final TextStyle? style = WidgetStateProperty.resolveAs(decoration.floatingLabelStyle, materialState) ?? WidgetStateProperty.resolveAs(themeData.inputDecorationTheme.floatingLabelStyle, materialState);

    return themeData.textTheme.titleMedium!.merge(widget.baseStyle).copyWith(height: 1).merge(defaultTextStyle).merge(style);
  }

  TextStyle _getHelperStyle(ThemeData themeData, CustomInputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(defaults.helperStyle!, materialState).merge(WidgetStateProperty.resolveAs(decoration.helperStyle, materialState));
  }

  TextStyle _getErrorStyle(ThemeData themeData, CustomInputDecorationTheme defaults) {
    return WidgetStateProperty.resolveAs(defaults.errorStyle!, materialState).merge(decoration.errorStyle);
  }
  ...
  InputBorder _getDefaultBorder(ThemeData themeData, CustomInputDecorationTheme defaults) {
    final InputBorder border = WidgetStateProperty.resolveAs(decoration.border, materialState) ?? const UnderlineInputBorder();
  ...
  Widget build(BuildContext context) {
    ...
    final CustomInputDecorationTheme defaults = Theme.of(context).useMaterial3 ? _InputDecoratorDefaultsM3(context) : _InputDecoratorDefaultsM2(context);
    ...
    final Widget helperError = _HelperError(
      ...
      errorPadding: decoration.errorPadding,
    );
    ...
    final _Decorator decorator = _Decorator(
      decoration: _Decoration(
          ...
          floatingLabelAlignment: const FloatingLabelAlignment._(-0.91),
...
/// Design text field.
///
/// The [TextField] and [CustomInputDecorator] classes use [CustomInputDecoration] objects
/// to describe their decoration. (In fact, this class is merely the
/// configuration of an [CustomInputDecorator], which does all the heavy lifting.)
///
/// {@tool dartpad}
...
/// message, provide `errorText` to the [CustomInputDecoration] constructor.
///
...
///  * [CustomInputDecorator], which is a widget that draws an [CustomInputDecoration]
...
class CustomInputDecoration {
  ...
  ///
  /// Unless specified by [ThemeData.inputDecorationTheme], [CustomInputDecorator]
  ...
  /// Defines an [CustomInputDecorator] that is the same size as the input field.
  ///
  ...
  /// The style to use for [CustomInputDecoration.labelText] when the label is on top
  /// of the input field.
  ///
  ...
  /// if the [TextField] is focused or not.
  ///
  /// When the [CustomInputDecoration.labelText] is above (i.e., vertically adjacent to)
  ...
  /// of [CustomInputDecoration] that changes the color of the label to the
  /// [CustomInputDecoration.errorStyle] color or [ColorScheme.error].
  ///
  /// {@tool dartpad}
  ...
  /// The style to use for [CustomInputDecoration.labelText] when the label is
  /// above (i.e., vertically adjacent to) the input field.
  ///
  /// When the [CustomInputDecoration.labelText] is on top of the input field, the
  ...
  /// Text that provides context about the [CustomInputDecorator.child]'s value, such
  /// as how the value will be used.
  ///
  /// If non-null, the text is displayed below the [CustomInputDecorator.child], in
  ...
  ///
  /// Displayed on top of the [CustomInputDecorator.child] (i.e., at the same location
  /// on the screen where text may be entered in the [CustomInputDecorator.child])
  ...
  /// top of the input field (i.e., at the same location on the screen where
  /// text may be entered in the [CustomInputDecorator.child]).
  ///
  /// If null, defaults to a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  ...
  /// Text that appears below the [CustomInputDecorator.child] and the border.
  ///
  ...
  /// The style to use for the [CustomInputDecoration.errorText].
  ///
  /// If null, defaults of a value derived from the base [TextStyle] for the
  /// input field and the current [Theme].
  ///
  /// By default the color of style will be used by the label of
  /// [CustomInputDecoration] if [CustomInputDecoration.errorText] is not null. See
  /// [CustomInputDecoration.labelStyle] or [CustomInputDecoration.floatingLabelStyle] for
  ...
  /// {@endtemplate}
  ///
  /// If null, [CustomInputDecorationTheme.floatingLabelBehavior] will be used.
  ///
  /// See also:
  ///
  ///  * [floatingLabelAlignment] which defines **where** the floating label
  ...
  /// {@endtemplate}
  ///
  /// If null, [CustomInputDecorationTheme.floatingLabelAlignment] will be used.
  ///
  /// See also:
  ///
  ///  * [floatingLabelBehavior] which defines **how** the floating label should
  ...
  /// Whether the [CustomInputDecorator.child] is part of a dense form (i.e., uses less vertical
  /// space).
  ///
  /// Defaults to false.
  final bool? isDense;
  ...
  ///
  /// When [CustomInputDecorator.isHovering] is true, the [hoverColor] is also blended
  ...
  /// [CustomInputDecorationTheme.fillColor].
  ///
  /// {@macro flutter.material.input_decorator.container_description}
  final Color? fillColor;
  ...
  /// [CustomInputDecorationTheme.focusColor].
  ///
  ...
  ///
  /// If [filled] is false, and [CustomInputDecorator.isFocused] is false, the color
  ...
  /// The border to display when the [CustomInputDecorator] does not have the focus and
  /// is showing an error.
  ///
  /// See also:
  ///
  ///  * [CustomInputDecorator.isFocused], which is true if the [CustomInputDecorator]'s child
  ///    has the focus.
  ///  * [CustomInputDecoration.errorText], the error shown by the [CustomInputDecorator], if non-null.
  ///  * [border], for a description of where the [CustomInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [CustomInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ///  * [OutlineInputBorder], an [CustomInputDecorator] border which draws a
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [focusedBorder], displayed when [CustomInputDecorator.isFocused] is true
  ///    and [CustomInputDecoration.errorText] is null.
  ///  * [focusedErrorBorder], displayed when [CustomInputDecorator.isFocused] is true
  ///    and [CustomInputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [CustomInputDecoration.enabled] is false
  ///    and [CustomInputDecoration.errorText] is null.
  ///  * [enabledBorder], displayed when [CustomInputDecoration.enabled] is true
  ///    and [CustomInputDecoration.errorText] is null.
  final InputBorder? errorBorder;

  /// The border to display when the [CustomInputDecorator] has the focus and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  ///    rounded rectangle around the input decorator's container.
  ///  * [InputBorder.none], which doesn't draw a border.
  ///  * [errorBorder], displayed when [CustomInputDecorator.isFocused] is false
  ///    and [CustomInputDecoration.errorText] is non-null.
  ///  * [focusedErrorBorder], displayed when [CustomInputDecorator.isFocused] is true
  ///    and [CustomInputDecoration.errorText] is non-null.
  ///  * [disabledBorder], displayed when [CustomInputDecoration.enabled] is false
  ...
  /// The border to display when the [CustomInputDecorator] has the focus and is
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The border to display when the [CustomInputDecorator] is disabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ///  * [CustomInputDecoration.enabled], which is false if the [CustomInputDecorator] is disabled.
  ///  * [CustomInputDecoration.errorText], the error shown by the [CustomInputDecorator], if non-null.
  ///  * [border], for a description of where the [CustomInputDecorator] border appears.
  ///  * [UnderlineInputBorder], an [CustomInputDecorator] border which draws a horizontal
  ///    line at the bottom of the input decorator's container.
  ...
  /// The border to display when the [CustomInputDecorator] is enabled and is not
  /// showing an error.
  ///
  /// See also:
  ///
  ...
  /// The decoration's container is the area which is filled if [filled] is
  /// true and bordered per the [border]. It's the area adjacent to
  /// [CustomInputDecoration.icon] and above the widgets that contain
  /// [CustomInputDecoration.helperText], [CustomInputDecoration.errorText], and
  /// [CustomInputDecoration.counterText].
  ///
  ...
  /// [CustomInputDecoration.errorText], [CustomInputDecoration.enabled],
  /// [CustomInputDecorator.isFocused] and the current [Theme].
  ///
  ...
  /// Typically set to true when the [CustomInputDecorator] contains a multiline
  ...
  /// Defines minimum and maximum sizes for the [CustomInputDecorator].
  ///
  ...
  /// [CustomInputDecorationTheme.constraints] will be used. If that
  ...
  /// Used by widgets like [TextField] and [CustomInputDecorator] to create a new
  /// [CustomInputDecoration] with default values taken from the [theme].
  ///
  /// Only null valued properties from this [CustomInputDecoration] are replaced
  /// by the corresponding values from [theme].
  CustomInputDecoration applyDefaults(CustomInputDecorationTheme theme) {
    return copyWith(
  ...
  bool operator ==(Object other) {
    ...
    return other is CustomInputDecoration &&
        other.icon == icon &&
...
/// Defines the default appearance of [CustomInputDecorator]s.
///
/// This class is used to define the value of [ThemeData.inputDecorationTheme].
/// The [CustomInputDecorator], [TextField], and [TextFormField] widgets use
/// the current input decoration theme to initialize null [CustomInputDecoration]
/// properties.
///
/// The [CustomInputDecoration.applyDefaults] method is used to combine a input
/// decoration theme with an [CustomInputDecoration] object.
@immutable
class CustomInputDecorationTheme with Diagnosticable {
  /// Creates a value for [ThemeData.inputDecorationTheme] that
  /// defines default values for [CustomInputDecorator].
  ///
  ...
  /// The style to use for [CustomInputDecoration.helperText].
  ///
  /// If [helperStyle] is a [WidgetStateTextStyle], then the effective
  /// text style can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The maximum number of lines the [CustomInputDecoration.helperText] can occupy.
  ///
  /// Defaults to null, which means that the [CustomInputDecoration.helperText] will
  ...
  /// See also:
  ///
  ///  * [errorMaxLines], the equivalent but for the [CustomInputDecoration.errorText].
  final int? helperMaxLines;

  /// The style to use for the [CustomInputDecoration.hintText].
  ///
  /// If [hintStyle] is a [WidgetStateTextStyle], then the effective
  /// text style can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ///
  /// Also used for the [CustomInputDecoration.labelText] when the
  /// [CustomInputDecoration.labelText] is displayed on top of the input field (i.e.,
  ...
  /// The maximum number of lines the [CustomInputDecoration.errorText] can occupy.
  ///
  /// Defaults to null, which means that the [CustomInputDecoration.errorText] will be
  ...
  /// See also:
  ///
  ///  * [helperMaxLines], the equivalent but for the [CustomInputDecoration.helperText].
  final int? errorMaxLines;
  ...
  /// [CustomInputDecoration.filled] is true and bordered per the [border].
  /// It's the area adjacent to [CustomInputDecoration.icon] and above the
  /// [CustomInputDecoration.icon] and above the widgets that contain
  /// [CustomInputDecoration.helperText], [CustomInputDecoration.errorText], and
  /// [CustomInputDecoration.counterText].
  ///
  ...
  /// Whether the decoration is the same size as the input field.
  ///
  /// A collapsed decoration cannot have [CustomInputDecoration.labelText],
  /// [CustomInputDecoration.errorText], or an [CustomInputDecoration.icon].
  final bool isCollapsed;

  /// The Color to use for the [CustomInputDecoration.icon].
  ///
  /// If [iconColor] is a [WidgetStateColor], then the effective
  /// color can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [CustomInputDecoration.prefixText].
  ///
  /// If [prefixStyle] is a [WidgetStateTextStyle], then the effective
  /// text style can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The Color to use for the [CustomInputDecoration.prefixIcon].
  ///
  /// If [prefixIconColor] is a [WidgetStateColor], then the effective
  /// color can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [CustomInputDecoration.suffixText].
  ///
  ...
  /// The Color to use for the [CustomInputDecoration.suffixIcon].
  ///
  /// If [suffixIconColor] is a [WidgetStateColor], then the effective
  /// color can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [CustomInputDecoration.counterText].
  ///
  /// If [counterStyle] is a [WidgetStateTextStyle], then the effective
  /// text style can depend on the [WidgetState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// See also:
  ///
  ///  * [CustomInputDecoration.constraints], which can override this setting for a
  ///    given decorator.
  final BoxConstraints? constraints;

  /// Creates a copy of this object but with the given fields replaced with the
  /// new values.
  CustomInputDecorationTheme copyWith({
    TextStyle? labelStyle,
    TextStyle? floatingLabelStyle,
    TextStyle? helperStyle,
    int? helperMaxLines,
    ...
    return CustomInputDecorationTheme(
      labelStyle: labelStyle ?? this.labelStyle,
      floatingLabelStyle: floatingLabelStyle ?? this.floatingLabelStyle,
      helperStyle: helperStyle ?? this.helperStyle,
      helperMaxLines: helperMaxLines ?? this.helperMaxLines,
  ...
  bool operator ==(Object other) {
    ...
    return other is CustomInputDecorationTheme &&
        other.labelStyle == labelStyle &&
        other.floatingLabelStyle == floatingLabelStyle &&
        other.helperStyle == helperStyle &&
        other.helperMaxLines == helperMaxLines &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    const CustomInputDecorationTheme defaultTheme = CustomInputDecorationTheme();
...
class _InputDecoratorDefaultsM2 extends CustomInputDecorationTheme {
...
class _InputDecoratorDefaultsM3 extends CustomInputDecorationTheme {
